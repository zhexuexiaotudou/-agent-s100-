...
- verdict: `ok_stage4_write_action_dryrun_planner_gate`
- generated_at: `2026-07-04T11:22:14.092030+08:00`
- passed: `6/6`

## Checks

- `PASS` dry-run plan file written
- `PASS` copy/rename/move/delete paths modeled
- `PASS` all plans are dry-run only
- `PASS` real NAS write plan is rejected
- `PASS` delete remains blocked for first canary
- `PASS` eligible sandbox plans include before/rollback hashes
...
```json
{
  "plans": "reports/stage4_write_action_dryrun_plans.json",
  "plan_count": 6,
  "plans_payload": [
    {
      ...
      "before_state_hash": "c96409768b8f76fbfe88934159d2f52f27f47efd703185c59547eaafc9d2b5f4",
      "rollback_plan": "delete target/public_doc_copy.txt",
      "rollback_plan_hash": "33b542085a40e0b9f07c4c09ad059fb059f11b7bae1fc9800c090393ee6a3945",
    ...
    },
    {
      ...
      "rollback_plan_hash": "8812e3e263503a0832e344ada7bb7b7df052bd4163936c6acfad24749f46a56a",
      "execution_allowed_now": false,
      "dry_run_only": true
    },
    {
      ...
      "rollback_plan_hash": "91f452d0fd54b30ab0ae102256d8248c3c7b8e7cb28ef07cb7c5d092e23a8df9",
      "execution_allowed_now": false,
      "dry_run_only": true
    },
    {
      ...
      "rollback_plan_hash": "8dfc939f441f6ef5d7d524e00ea08fb3a348364d54e3c14d52b162f947dc4e11",
      "execution_allowed_now": false,
      "dry_run_only": true,
