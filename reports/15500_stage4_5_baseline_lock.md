# stage4_5_baseline_lock

- verdict: `ok_stage4_5_baseline_lock`
- generated_at: `2026-07-04T13:57:35.633058+08:00`
- passed: `8/8`

## Checks

- `PASS` Stage4.4 route packet exists
- `PASS` Stage4.4 ended with execute blocked safely
...
- `PASS` global execute/rollback flags are closed before canary
...
```json
{
  ...
  "stage4_4_final_verdict": "copy_route_execute_canary_blocked_safely",
  "remote_identity": {
    "returncode": 0,
    "elapsed_ms": 237.559,
