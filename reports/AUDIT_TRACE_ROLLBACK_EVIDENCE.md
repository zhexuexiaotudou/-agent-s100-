...
```json
{
  ...
  "runtime_trace": {
    "stage4_readonly_regression_summary": {
    ...
    "stage3_cloud_egress_summary": {
      "scenario_count": 6,
      "leak_count": 0,
      "cloud_private_egress_count": 0,
      "raw_private_payload_stored_count": 0
    },
    "adversarial_privacy_summary": {
      "case_count": 100,
      "private_leak_count": 0,
      "execution_count": 0,
      "cloud_private_egress_count": 0,
  ...
  "audit": {
    "tool_calls_count": 50,
    "policy_denials_count": 50,
    "cloud_private_egress_count": 0,
    "approval_token_evidence": {
      "found": true,
      "path": "reports/13200_stage4_signed_approval_token_gate.json",
      "sha256": "96d8df38eb7f51c8db365491489c8719e52cfe48e6b708c47eaaf3e6420deda9",
  ...
  "sandbox_write_canary": {
    ...
    "before_state": {
      "generated_at": "2026-07-04T11:22:14.096874+08:00",
    ...
    "after_state": {
      "generated_at": "2026-07-04T11:22:14.112510+08:00",
      "sandbox_root": "F:\\Project\\Digua\\tmp\\digua_ai_nas_write_sandbox",
      "sandbox_root_relative": "tmp/digua_ai_nas_write_sandbox",
      "real_nas_path": false,
      "file_count": 5,
    ...
    "canary_result": {
      "operator_approval_env_present": true,
      "approval_source": "AI_NAS_OPERATOR_APPROVED_SANDBOX_WRITE_CANARY=1",
      ...
      "write_action": {
        ...
        "target": "tmp/digua_ai_nas_write_sandbox/target/canary_public_doc_copy.txt",
        "target_sha256": "3b96300402065947c4d31532645c6baa06cdf27c3b6102da9a72a330aca3b52f"
      },
      "after_write_manifest_hash": "f1b0ad54dc2aa01e1d7d489137f49b05064e19152e92b0dcb93d1df2e7036fb6",
      "after_rollback_manifest_hash": "c96409768b8f76fbfe88934159d2f52f27f47efd703185c59547eaafc9d2b5f4",
      "blocked_reason": null
    }
  },
  "write_boundary": {
