...
ROS bag 采集 & doing & NAS-backed start/status/stop self-test 通过；命名采集 policy 已生成，还需一次人工批准的 named capture。 \\
...
项目 & 路径 \\
\midrule
Baseline roll-up & \path{/mnt/nas/openclaw/reports/baseline-status/baseline_status_20260528-225904.md} \\
Stability summary & \path{/mnt/nas/openclaw/reports/stability/stability_summary_20260528-223427.md} \\
