# stage2_s100p_live_provider_and_route_integrity_gate

- verdict: `ok_stage2_s100p_live_provider_and_route_integrity_gate`
- generated_at: `2026-07-03T01:38:06.204047+08:00`
- passed: `9/9`

## Checks

- `PASS` OpenClaw 8765 healthy
- `PASS` Qwen 18080 healthy
- `PASS` Qwen models endpoint local
- `PASS` dispatcher hash recorded
- `PASS` OpenClaw service hash recorded
- `PASS` Qwen service unit or live process recorded
- `PASS` provider default points to local Qwen
- `PASS` no sidecar on protected ports before start
- `PASS` Dream/llama observed only
...
```json
{
  ...
  "qwen_models": {
    ...
    "body_hash": "813f480ad25b8bcde013924b1775aa60b3bd754ff9cc43190c6b4313eb4f2198",
    "stderr_hash": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
    "stderr_tail": ""
  },
  "model_id": "Qwen2.5-1.5B-Instruct-S100P-official",
