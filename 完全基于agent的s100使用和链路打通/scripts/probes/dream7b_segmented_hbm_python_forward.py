...
RESPLIT_TOPWINDOW_ADJACENT_SEGMENTS = [
    ...
    ("seg10_12", "resplit", "seg10_12/dream7b_segment_10_12_seq16_q8.hbm", "dream_segment_10_12", "hidden"),
    ("seg12_14", "resplit", "seg12_14/dream7b_segment_12_14_seq16_q8.hbm", "dream_segment_12_14", "hidden"),
    ("seg14_15", "topwindow", "seg14_15/dream7b_segment_14_15_seq16_q8.hbm", "dream_segment_14_15", "hidden"),
    ("seg15_17", "topwindow", "seg15_17/dream7b_segment_15_17_seq16_q8.hbm", "dream_segment_15_17", "hidden"),
    ("seg17_18", "topwindow", "seg17_18/dream7b_segment_17_18_seq16_q8.hbm", "dream_segment_17_18", "hidden"),
    ("seg18_19", "topwindow", "seg18_19/dream7b_segment_18_19_seq16_q8.hbm", "dream_segment_18_19", "hidden"),
    ("seg19_21", "resplit", "seg19_21/dream7b_segment_19_21_seq16_q8.hbm", "dream_segment_19_21", "hidden"),
...
PHASE1_TOPLOAD_ADJACENT_SEGMENTS = [
    ("seg00_01", "resplit", "seg00_01/dream7b_segment_0_1_seq16_q8.hbm", "dream_segment_00_01", "tokens"),
    ("seg01_02", "resplit", "seg01_02/dream7b_segment_1_2_seq16_q8.hbm", "dream_segment_01_02", "hidden"),
    ("seg02_03", "phase1", "seg02_03/dream7b_segment_2_3_seq16_q8.hbm", "dream_segment_02_03", "hidden"),
    ("seg03_04", "phase1", "seg03_04/dream7b_segment_3_4_seq16_q8.hbm", "dream_segment_03_04", "hidden"),
    ("seg04_05", "phase1", "seg04_05/dream7b_segment_4_5_seq16_q8.hbm", "dream_segment_04_05", "hidden"),
    ("seg05_07", "phase1", "seg05_07/dream7b_segment_5_7_seq16_q8.hbm", "dream_segment_05_07", "hidden"),
    ("seg07_08", "topwindow", "seg07_08/dream7b_segment_7_8_seq16_q8.hbm", "dream_segment_07_08", "hidden"),
    ("seg08_10", "topwindow", "seg08_10/dream7b_segment_8_10_seq16_q8.hbm", "dream_segment_08_10", "hidden"),
    ("seg10_12", "resplit", "seg10_12/dream7b_segment_10_12_seq16_q8.hbm", "dream_segment_10_12", "hidden"),
    ("seg12_14", "resplit", "seg12_14/dream7b_segment_12_14_seq16_q8.hbm", "dream_segment_12_14", "hidden"),
...
def parse_args():
    ...
    parser.add_argument("--phase1-hbm-dir", default="/mnt/nas/openclaw/models/dream7b-hbm/phase1-topload-seq16")
    parser.add_argument(
        "--segment-plan",
        choices=("segments6", "fine-adjacent", "resplit-adjacent", "resplit-topwindow-adjacent", "phase1-topload-adjacent"),
        default="segments6",
    )
    parser.add_argument(
    ...
    parser.add_argument("--dry-run-segments", action="store_true", help="Resolve the segment plan and report missing HBM files without loading BPU runtimes.")
    return parser.parse_args()


def resolve_segments(segment_plan: str, hbm_dir: Path, fine_hbm_dir: Path, resplit_hbm_dir: Path, topwindow_hbm_dir: Path, phase1_hbm_dir: Path):
    ...
    elif segment_plan == "phase1-topload-adjacent":
        specs = PHASE1_TOPLOAD_ADJACENT_SEGMENTS
    else:
...
def main():
    ...
    phase1_hbm_dir = Path(args.phase1_hbm_dir)
    output_dir = Path(args.output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)
    segments = resolve_segments(args.segment_plan, hbm_dir, fine_hbm_dir, resplit_hbm_dir, topwindow_hbm_dir, phase1_hbm_dir)
    if args.dry_run_segments:
        segment_rows = []
            ...
            segment_rows.append(
                {
                    ...
                    "size_bytes": model_file.stat().st_size if model_file.is_file() else 0,
                }
            )
        missing = [item for item in segment_rows if not item["exists"]]
        dry_run = {
            "generated_at": datetime.now().astimezone().isoformat(),
            "verdict": "ok_dream7b_segmented_hbm_python_forward_dry_run_segments" if not missing else "blocked_dream7b_segmented_hbm_python_forward_dry_run_segments",
        ...
        (output_dir / "segment_plan_preflight.json").write_text(json.dumps(dry_run, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
