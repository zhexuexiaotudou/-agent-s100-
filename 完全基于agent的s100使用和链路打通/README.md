...
- Current Dream 7B top-window round3 artifacts: `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_hbm_artifact_inventory_20260609-152820/resplit_hbm_artifact_inventory_probe.json` verifies `/mnt/nas/openclaw/models/dream7b-hbm/resplit-topwindow-seq16`, and `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_hbm_artifact_inventory_20260609-152823/resplit_hbm_artifact_inventory_probe.json` verifies `/home/sunrise/.cache/openclaw/dream7b-hbm/resplit-topwindow-seq16`; both report `expected_specs: ['7:8', '8:10', '14:15', '15:17', '17:18', '18:19', '21:22', '22:24']`, `expected_hbm_count: 8`, `existing_hbm_count: 8`, `manifest_entry_count: 8`, `manifest_verified_count: 8`, `total_hbm_size_bytes: 2512771264`, and `errors: []`.
- Current Dream 7B top-window round3 telemetry: `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_batch_telemetry_20260609-153118/resplit_batch_telemetry_probe.json` records `verdict: ok_dream7b_bpu_resplit_batch_telemetry_probe`, `batch_count: 16`, `expected_segment_plan: resplit-topwindow-adjacent`, `forward_metrics.segment_event_count: 288`, `forward_metrics.segment_sources: ['base', 'fine', 'resplit', 'topwindow']`, `max_bpu_loading: 100.0`, `avg_bpu_loading: 9.628`, and `forward_metrics.load_to_run_ratio: 9.468172`. `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_window_cost_20260609-153244/resplit_window_cost_probe.json` records `window_count: 9`, `total_load_ms: 23166.108`, `total_run_ms: 2446.735`, `load_to_run_ratio: 9.468172`, top absolute-load window `['seg02_04', 'seg04_07']`, and top load/run-ratio window `['seg00_01', 'seg01_02']`. `/mnt/nas/openclaw/reports/models/dream7b_bpu_utilization_gap_20260609-153933/utilization_gap_probe.json` keeps `diagnosis: hbm_reload_dominated`, `resplit_batch_telemetry.load_to_run_ratio: 9.468`, and `resplit_batch_telemetry.avg_bpu_loading: 9.628`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260609-154013/deployment_acceptance_probe.json` records `check_count: 30`, `passed_check_count: 30`, and `utilization_gap.ok: True`. Round3 improves the previous `load_to_run_ratio` of `9.694618`, but it is still not a sustained 128TOPS utilization solution.
...
- Historical S100 official Qwen 1024/256 failure result: `scripts/probes/s100_official_qwen_fullflow_probe.sh` first used `model_name: qwen2_5-1_5b`, `march: nash-m`, `cache_len: 1024`, and `chunk_size: 256`. The x86_64 AVX WSL build artifact report is archived at `/mnt/nas/openclaw/reports/models/qwen_fullflow_wsl_build_report_20260609-081247/official_qwen_fullflow_probe.json`; it records `source_model_exists: true`, `build_host_compatible: true`, `compiled_hbm_path: /mnt/f/Project/Digua/tmp/models/s100-official-qwen-fullflow/qwen2_5-1_5b_chunk_256_cache_1024_q8.hbm`, and `compiled_hbm_size_bytes: 1917926648`, while `oellm_build` returns `1` during host-side HBM load/link verification because WSL has no ION/common-buffer device. The S100P runtime report `/mnt/nas/openclaw/reports/models/s100_official_qwen_fullflow_20260609-172710/official_qwen_fullflow_probe.json` records `source_model_exists: true`, `compiled_hbm_size_bytes: 1917926648`, `isolated_runtime_config_written: true`, `runtime_attempted: true`, `hbm_load_success_observed: true`, `init_model_success_observed: true`, `memory_alloc_failure_observed: true`, and `runtime_returncode: -11`, so 1024/256 is retained as a high-context BPU/common-buffer allocation failure case rather than the Dream migration baseline.
- Historical Dream 7B OELLM preflight result: `/mnt/nas/openclaw/reports/models/dream7b_oellm_fullflow_feasibility_20260609-152748/dream7b_oellm_fullflow_feasibility_probe.json` records `dream_registered_in_official_sdk: false`, `supported_models_from_sdk: ['deepseek-qwen-1_5b', 'deepseek-qwen-7b', 'qwen2_5-1_5b', 'qwen2_5-7b', 'internvl2-2b', 'internvl2_5-2b', 'internvl2-1b', 'internvl2_5-1b', 'internlm2-1_8b', 'qwen2_5-omni-3b']`, `build_host_compatible: false`, `compile_status: blocked_preflight`, `direct_oellm_migration_supported: false`, and `failure_stage: preflight`; the current Dream OELLM decision is superseded by the 512/128-aligned registry-missing report below.
- Current 2026-06-09 Qwen/Dream migration acceptance: Qwen2.5-1.5B `cache_len: 512`, `chunk_size: 128` is the official runnable LLM baseline. Its HBM is `/mnt/nas/openclaw/models/s100-official-qwen-fullflow/cache_len_512_chunk_128/qwen2_5-1_5b_chunk_128_cache_512_q8.hbm`, and `/mnt/nas/openclaw/reports/models/s100_official_qwen_fullflow_20260609-210514/official_qwen_fullflow_probe.json` records `runtime_completed: true`, `runtime_returncode: 0`, `memory_alloc_failure_observed: false`, `nonzero_bpu_loading_sample_count: 6`, `max_bpu_loading: 98.0`, `avg_bpu_loading: 2.222`, and `Performance prefill: 1024.00tokens/s    decode: 25.57tokens/s`. `/mnt/nas/openclaw/reports/models/s100_qwen15_common_buffer_diagnosis_20260609-211000/s100_qwen15_common_buffer_diagnosis_20260609.md` keeps the common-buffer diagnosis and the 1024/256 high-context failure boundary.
- Current Dream 7B OELLM migration result: `/mnt/nas/openclaw/reports/models/dream7b_oellm_fullflow_feasibility_20260609-223754/dream7b_oellm_fullflow_feasibility_probe.json` uses the same 512/128 Qwen baseline assumptions and records `build_host_compatible: true`, `dream_registered_in_official_sdk: false`, `compile_status: blocked_registry_missing`, `failure_stage: registry_missing`, `compiled_hbm_count: 0`, `direct_oellm_migration_supported: false`, `missing_adapter_evidence.registry_missing: true`, and `missing_adapter_evidence.required_adapter: official leap_llm model_factory registration and Dream/DreamModel adapter`. The minimal failure package includes the Dream source/config path, config summary (`model_type: Dream`, `architectures: ['DreamModel']`, `hidden_size: 3584`, `num_hidden_layers: 28`, `num_attention_heads: 28`, `num_key_value_heads: 4`, `vocab_size: 152064`, `mask_token_id: 151666`, `torch_dtype: bfloat16`, `use_cache: true`), SDK registry list, empty compile stdout/stderr placeholders, and `unable_to_attempt_direct_official_compile_reason`; this is an SDK adapter gap, not an AVX/build-host failure.
- Current Dream 7B top-window refresh: `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_hbm_artifact_inventory_20260609-224012/resplit_hbm_artifact_inventory_probe.json` and `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_hbm_artifact_inventory_20260609-224035/resplit_hbm_artifact_inventory_probe.json` both verify `expected_hbm_count: 8`, `existing_hbm_count: 8`, `manifest_verified_count: 8`, and `total_hbm_size_bytes: 2512771264`. `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_batch_telemetry_20260609-224100/resplit_batch_telemetry_probe.json` records `avg_bpu_loading: 8.97` and `forward_metrics.load_to_run_ratio: 9.678265`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_window_cost_20260609-224142/resplit_window_cost_probe.json` records `load_to_run_ratio: 9.678265`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_utilization_gap_20260609-224156/utilization_gap_probe.json` keeps `diagnosis: hbm_reload_dominated`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260609-224157/deployment_acceptance_probe.json` records `check_count: 30` and `passed_check_count: 30`. This latest rerun improves the historical `9.694618` but does not beat the current best `9.468172`, so it is not a new 128TOPS-utilization success claim.
- Current official DeepSeek 7B fallback result: `scripts/probes/s100_official_deepseek7b_baseline_probe.sh` downloads and runs the official DeepSeek-R1-Distill-Qwen-7B HBM in an isolated config without changing SDK examples or board memory settings. `/mnt/nas/openclaw/reports/models/s100_official_deepseek7b_baseline_20260610-023455/deepseek7b_baseline_probe.json` records HBM `/mnt/nas/openclaw/models/s100-official-deepseek-r1-distill-qwen-7b/DeepSeek_R1_Distill_Qwen_7B_1024.hbm`, `hbm_size_bytes: 7928846896`, `download_status: skipped_existing_hbm`, `runtime_status: failed`, `runtime_returncode: 1`, `runtime_completed: False`, `hbm_load_success_observed: False`, `init_model_success_observed: False`, `memory_alloc_failure_observed: True`, `bpu_alloc_request_bytes: 7928846896`, and `decision: official_7b_runtime_blocked_common_buffer`. This proves the official 7B HBM is present but not deployable on the current S100P memory layout; Qwen2.5-1.5B `512/128` remains the verified official runnable fallback and is currently the only verified official fallback.
- Current Dream reload optimization closure: `docs/dream7b_vendor_support_package_2026-06-10.md` is the forwardable teacher/vendor package for the DeepSeek 7B memory-layout block and Dream `registry_missing` adapter block. `scripts/probes/dream7b_bpu_reload_optimization_probe.sh` aggregates persistent cache, file prefetch/local-cache, selected-pair cache, window scheduling, and BPU core scheduling evidence. `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_batch_telemetry_20260610-030740/resplit_batch_telemetry_probe.json` records `avg_bpu_loading: 8.811`, `max_bpu_loading: 100.0`, `forward_metrics.load_to_run_ratio: 9.524202`, and `forward_metrics.wall_ms: 26007.248`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_window_cost_20260610-030820/resplit_window_cost_probe.json` is the matching top-window cost report; `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_telemetry_20260610-031613/selected_pair_telemetry_probe.json` records `selected_pair: [1, 8]`, `selected_pair_covers_all_segments: True`, `selected_pair.wall_ms: 22982.452`, `selected_pair.avg_bpu_loading: 8.984`, `selected_pair_wall_delta_ratio_vs_resplit: 0.116306`, and `selected_pair_avg_bpu_delta_vs_resplit: 0.173`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_utilization_gap_20260610-031818/utilization_gap_probe.json` keeps `diagnosis: hbm_reload_dominated`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260610-031818/deployment_acceptance_probe.json` records `check_count: 30` and `passed_check_count: 30`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_reload_optimization_20260610-031828/reload_optimization_probe.json` records `final_decision: utilization_progress_candidate`, `substantial_improvement_observed: True`, `best_load_to_run_ratio: 9.468172`, and `ratio_delta_vs_best: 0.05603`. The top-window path is still `hbm_reload_dominated`, but selected-pair resident execution is now a guarded candidate based on batch16 wall-time and average-BPU improvement.
- Current Dream selected-pair sustained service closure: `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_candidate_service_telemetry_20260610-032523/systemd_telemetry_probe.json` verifies `dream7b-bpu-selected-pair-candidate.service` without replacing `dream7b-bpu-batch-queue.service`; it records `processed_request_count: 48`, `batch_counts: [16, 16, 16]`, `amortized_wall_ms_per_processed_request: 1445.673`, `avg_bpu_loading: 8.371`, `max_bpu_loading: 98.0`, `load_to_run_ratio: 9.859028`, `wall_ms_delta_ratio_vs_default_systemd: 0.130546`, and `candidate_avg_bpu_loading_not_worse_than_default_systemd: False`. `/mnt/nas/openclaw/reports/models/dream7b_bpu_utilization_gap_20260610-032709/utilization_gap_probe.json` keeps `diagnosis: hbm_reload_dominated`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260610-032709/deployment_acceptance_probe.json` keeps `check_count: 30` and `passed_check_count: 30`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_reload_optimization_20260610-032926/reload_optimization_probe.json` records `final_decision: guarded_sustained_wall_time_candidate`, `sustained_service_decision: guarded_sustained_wall_time_candidate`, `default_service_replacement_decision: do_not_replace_default_service_yet`, `wall_delta_ratio_vs_resplit_per_request: 0.110603`, `avg_bpu_delta_vs_resplit: -0.44`, and `avg_bpu_delta_vs_selected_pair_single: -0.613`. This is a rollback-gated wall-time candidate, not a default-service replacement and not a solved 128TOPS average-utilization claim.
- Current Dream selected-pair service promotion gate: `scripts/probes/dream7b_bpu_selected_pair_service_promotion_gate_probe.sh` produced `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_service_promotion_gate_20260610-141720/selected_pair_service_promotion_gate_probe.json`, which records `verdict: ok_dream7b_bpu_selected_pair_service_promotion_gate_probe`, `promotion_allowed: False`, `promotion_decision: block_default_service_replacement`, `default_service_replaced: False`, `candidate_service_isolated_from_default: True`, `candidate_load_to_run_ratio: 9.859028`, `wall_delta_ratio_vs_default_systemd: 0.130546`, `wall_delta_ratio_vs_resplit_per_request: 0.110603`, `avg_bpu_delta_vs_default_systemd: -1.245`, `avg_bpu_delta_vs_resplit: -0.44`, `utilization_diagnosis: hbm_reload_dominated`, and blockers `promotion_average_bpu_not_worse_vs_default`, `promotion_average_bpu_improved_vs_resplit`, `promotion_load_to_run_not_worse_than_best`, `promotion_not_hbm_reload_dominated`, and `reload_gate_allows_default_replacement`. Rollback keeps `sudo systemctl restart dream7b-bpu-batch-queue.service`; the gate preserves `dream7b-bpu-batch-queue.service` as the active default and keeps selected-pair as candidate-only until average BPU loading and load/run improve.
- Current Dream promotion blocker diagnosis: `scripts/probes/dream7b_bpu_promotion_blocker_diagnosis_probe.sh` produced `/mnt/nas/openclaw/reports/models/dream7b_bpu_promotion_blocker_diagnosis_20260610-145739/promotion_blocker_diagnosis_probe.json`, which records `verdict: ok_dream7b_bpu_promotion_blocker_diagnosis_probe`, `promotion_decision: keep_candidate_only_until_blockers_clear`, `candidate_load_to_run_ratio: 9.859028`, `load_to_run_delta_vs_best: 0.390856`, `load_to_run_delta_vs_resplit: 0.334826`, `service_avg_bpu_loading: 8.371`, `avg_bpu_delta_vs_resplit: -0.44`, `wall_delta_ratio_vs_resplit_per_request: 0.110603`, `top_load_to_run_ratio_window.resident_segments: ['seg00_01', 'seg01_02']`, `top_load_to_run_ratio_window.load_to_run_ratio: 18.585073`, `top_load_window.resident_segments: ['seg02_04', 'seg04_07']`, `top_load_window.load_ms: 3562.79`, `max_resident_segment_count_observed: 3`, `successful_seeded_quad_count: 0`, and `recommended_resplit_segment_indexes: [0, 9, 4, 6]`. The next optimization target is `prefix_micro_window_reload_reduction` first, then `seg02_04_seg04_07_window_cost_reduction`.
- Current Dream final optimization acceptance: `scripts/probes/dream7b_final_optimization_acceptance_probe.sh` produced `/mnt/nas/openclaw/reports/models/dream7b_final_optimization_acceptance_20260610-161744/final_optimization_acceptance_probe.json`, which records `verdict: ok_dream7b_final_optimization_acceptance_probe`, `final_goal_satisfied: True`, `final_decision: dream7b_bpu_optimized_candidate_complete_candidate_only`, `deployment_route_closed: True`, `substantial_improvement_observed: True`, `utilization_statement_compliant: True`, `promotion_gate_closed: True`, `dream_oellm_registry_missing: True`, `qwen_fallback_verified: True`, `deepseek7b_blocked_common_buffer: True`, `candidate_service_only: True`, `default_service_replaced: False`, `selected_pair_wall_delta_ratio_vs_resplit: 0.116306`, `sustained_wall_delta_ratio_vs_resplit_per_request: 0.110603`, `sustained_wall_delta_ratio_vs_default_systemd: 0.130546`, and `sustained_request_count: 48`. This is the final candidate-only acceptance: Dream 7B has a reproducible, accepted, rollback-gated BPU optimization candidate with measured wall-time improvement, while default service replacement remains blocked by average BPU and load/run.
- Current Dream normal-use acceptance: `scripts/probes/dream7b_bpu_normal_use_acceptance_probe.sh` produced `/mnt/nas/openclaw/reports/models/dream7b_bpu_normal_use_acceptance_20260610-170005/normal_use_acceptance_probe.json`, which records `verdict: ok_dream7b_bpu_normal_use_acceptance_probe`, `normal_use_ready: True`, `unmet_requirements: []`, `stable_sustained_service: True`, `preferred_96_request_sustained_observed: True`, `deployment_acceptance_clean: True`, `performance_floor_met: True`, `reload_relief_observed: True`, `deployable_rollback_safe: True`, and `utilization_claim_compliant: True`. The selected-pair 48-request service report `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_candidate_service_telemetry_20260610-165645/systemd_telemetry_probe.json` records `processed_request_count: 48`, `batch_counts: [16, 16, 16]`, `failed_job_count: 0`, `amortized_wall_ms_per_processed_request: 1448.877`, `avg_bpu_loading: 8.578`, `max_bpu_loading: 96.0`, `wall_delta_ratio_vs_resplit_per_request: 0.102517`, `wall_delta_ratio_vs_default_systemd: 0.128619`, and `load_to_run_ratio: 9.863791`; the preferred 96-request stability report is `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_candidate_service_telemetry_20260610-163241/systemd_telemetry_probe.json`. The post-blocker top-window experiment uses `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_batch_telemetry_20260610-165429/resplit_batch_telemetry_probe.json` and `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_window_cost_20260610-165513/resplit_window_cost_probe.json`; the window-cost report records `load_to_run_ratio: 9.443895` versus previous `9.774037`, with `top_ratio_improved: True`, `top_load_improved: True`, and `overall_load_to_run_improved: True`. This reaches the normal-use candidate threshold, but it still does not authorize default service replacement because sustained `avg_bpu_loading` and `load_to_run_ratio` remain below the promotion targets.
- Current Dream default-deployable final gate: `scripts/probes/dream7b_bpu_default_deployable_acceptance_probe.sh` produced `/mnt/nas/openclaw/reports/models/dream7b_bpu_default_deployable_acceptance_20260610-173758/default_deployable_acceptance_probe.json`, which records `verdict: ok_dream7b_bpu_default_deployable_acceptance_probe`, `default_deployable_ready: False`, `default_deployable_status: blocked_candidate_only`, `processed_request_count: 192`, `failed_job_count: 0`, `preferred_sustained_observed: True`, `deployment_acceptance_clean: True`, `promotion_allowed: False`, `performance_pass_count: 1`, `min_performance_pass_count: 3`, `amortized_wall_ms_per_processed_request: 1450.4`, `avg_bpu_loading: 8.476`, `load_to_run_ratio: 9.873488`, `service_performance_pass_count_below_3`, `service_avg_bpu_below_default_deploy_threshold`, and `service_load_to_run_above_default_deploy_threshold`. The matching reports `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_service_promotion_gate_20260610-173049/selected_pair_service_promotion_gate_probe.json` and `/mnt/nas/openclaw/reports/models/dream7b_bpu_reload_optimization_20260610-173049/reload_optimization_probe.json` keep `promotion_decision: block_default_service_replacement`, `utilization_diagnosis: hbm_reload_dominated`, and `default_service_replacement_decision: do_not_replace_default_service_yet`. Cross-job reuse remains a prototype only: `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_cross_job_reuse_20260610-172408/selected_pair_cross_job_reuse_probe.json` records `processed_forward_count: 128`, `load_to_run_ratio: 8.895442`, `amortized_wall_ms_per_forward: 1448.768`, `load_ms_delta_ratio_vs_service: 0.10225`, and `cross_job_wall_time_improved: True`, but it is not yet a deployed service and only passes 2 default-deploy performance checks.
- Current Dream cross-job queue runner candidate: `scripts/dream7b_bpu_selected_pair_cross_job_queue_runner.py` drains multiple queue jobs in one selected-pair resident worker session through `DREAM7B_BPU_SELECTED_PAIR_TOKENS_BATCHES_BY_JOB_JSON`. The 6x16 report `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_cross_job_queue_runner_20260610-175302/cross_job_queue_summary.json` records `verdict: ok_dream7b_bpu_selected_pair_cross_job_queue_runner`, `processed_job_count: 6`, `processed_request_count: 96`, `failed_job_count: 0`, `load_to_run_ratio: 8.890613`, `amortized_wall_ms_per_processed_request: 1438.937`, `amortized_total_load_ms_per_processed_request: 1309.349`, and `selected_pair_covers_all_segments: True`; the preferred 12x16 report `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_cross_job_queue_runner_20260610-175739/cross_job_queue_summary.json` records `processed_job_count: 12`, `processed_request_count: 192`, `failed_job_count: 0`, `load_to_run_ratio: 8.904793`, and `amortized_wall_ms_per_processed_request: 1459.145`. The refreshed final gate `/mnt/nas/openclaw/reports/models/dream7b_bpu_default_deployable_acceptance_20260610-180307/default_deployable_acceptance_probe.json` includes this runner as `cross_job_queue_candidate`, records `default_deployable_ready: False`, `default_deployable_status: blocked_candidate_only`, `cross_job_queue_candidate.performance_pass_count: 1`, `cross_job_queue_candidate.preferred_sustained_observed: True`, `cross_job_queue_candidate.load_to_run_ratio: 8.904793`, and keeps `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260610-180307/deployment_acceptance_probe.json` plus `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_service_promotion_gate_20260610-180307/selected_pair_service_promotion_gate_probe.json` as the latest clean acceptance and blocked promotion evidence. This proves cross-job queue reuse can reduce load/run below 9.0, but it still needs serviceization and a third performance pass before default promotion.
- Current Dream cross-job candidate service telemetry and promotion: `scripts/install_dream7b_bpu_selected_pair_cross_job_candidate_service.sh` installs `dream7b-bpu-selected-pair-cross-job-candidate.service` as an isolated systemd candidate without replacing `dream7b-bpu-batch-queue.service`. `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_cross_job_candidate_service_telemetry_20260610-182409/service_telemetry_probe.json` records `verdict: ok_dream7b_bpu_selected_pair_cross_job_candidate_service_telemetry_probe`, `processed_request_count: 192`, `failed_job_count: 0`, `load_to_run_ratio: 8.66679`, `avg_bpu_loading: 10.108`, `max_bpu_loading: 98.0`, and `amortized_wall_ms_per_processed_request: 1430.794`. `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_cross_job_service_promotion_gate_20260610-183109/cross_job_service_promotion_gate_probe.json` records `verdict: ok_dream7b_bpu_selected_pair_cross_job_service_promotion_gate_probe`, `promotion_allowed: True`, `promotion_decision: ready_for_default_service_replacement`, `default_service_replaced: False`, and `promotion_blockers: []`. The refreshed final gate `/mnt/nas/openclaw/reports/models/dream7b_bpu_default_deployable_acceptance_20260610-183252/default_deployable_acceptance_probe.json` records `default_deployable_ready: False`, `default_deployable_status: ready_for_default_replacement_candidate_only`, `cross_job_service_candidate.performance_pass_count: 3`, `cross_job_service_candidate.ready_for_default_replacement: True`, and `cross_job_service_candidate.default_replaced_and_ready: False`. This is the first Dream 7B S100P route that passes the load/run, average-BPU, and long-stability performance gates; it is still not the final default deployment because the default service has not been replaced and the cross-job service currently batches at least two jobs before running.
- Single-job fallback flush is now verified for the same cross-job candidate route. `scripts/probes/dream7b_bpu_selected_pair_cross_job_service_fallback_probe.sh` writes one pending request and confirms `--single-job-flush-timeout-sec` drains it without waiting for a second job. `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_cross_job_service_fallback_20260610-185916/cross_job_service_fallback_probe.json` records `verdict: ok_dream7b_bpu_selected_pair_cross_job_service_fallback_probe`, `single_job_fallback_ok: True`, `run_reason: single_job_flush_timeout`, `processed_request_count: 1`, `failed_job_count: 0`, `load_to_run_ratio: 155.028327`, and `amortized_wall_ms_per_processed_request: 20577.422`. The fallback-aware promotion gate `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_cross_job_service_promotion_gate_20260610-185941/cross_job_service_promotion_gate_probe.json` records `promotion_allowed: True`, `promotion_blockers: []`, and `single_job_fallback_ok: True`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_default_deployable_acceptance_20260610-185941/default_deployable_acceptance_probe.json` still records `default_deployable_status: ready_for_default_replacement_candidate_only` because `default_service_replaced: False`.
- Dream 7B default promotion is now verified. `scripts/probes/dream7b_bpu_cross_job_default_promotion_probe.sh` published the stable runtime at `/mnt/nas/openclaw/runtimes/dream7b-bpu-cross-job-default`, replaced `dream7b-bpu-batch-queue.service` with the cross-job selected-pair service on the default queue `/mnt/nas/openclaw/queues/dream7b-bpu`, ran a default-queue smoke request, restored the original unit once to verify rollback, and then re-applied the promoted unit. `/mnt/nas/openclaw/reports/models/dream7b_bpu_cross_job_default_promotion_20260610-190712/cross_job_default_promotion_probe.json` records `verdict: ok_dream7b_bpu_cross_job_default_promotion_probe`, `default_service_replaced: True`, `rollback_verified: True`, and `errors: []`. `scripts/probes/dream7b_bpu_cross_job_default_service_telemetry_probe.sh` then verified the promoted default service through the default queue: `/mnt/nas/openclaw/reports/models/dream7b_bpu_cross_job_default_service_telemetry_20260610-191115/default_service_telemetry_probe.json` records `verdict: ok_dream7b_bpu_cross_job_default_service_telemetry_probe`, `processed_request_count: 192`, `failed_job_count: 0`, `queue_done_count: 12`, `queue_failed_count: 0`, `load_to_run_ratio: 8.734653`, `avg_bpu_loading: 9.915`, `max_bpu_loading: 98.0`, and `amortized_wall_ms_per_processed_request: 1441.545`. Replacement-time deployment acceptance `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260610-192303/deployment_acceptance_probe.json` records `verdict: ok_dream7b_bpu_deployment_acceptance_probe`, `check_count: 30`, `passed_check_count: 30`, and `errors: []`. The final gate `/mnt/nas/openclaw/reports/models/dream7b_bpu_default_deployable_acceptance_20260610-192303/default_deployable_acceptance_probe.json` records `default_deployable_ready: True`, `default_deployable_status: ready`, `cross_job_default_service.performance_pass_count: 3`, `cross_job_service_candidate.default_replaced_and_ready: True`, `cross_job_service_candidate.rollback_verified: True`, `blockers: []`, and `warnings: []`.
...
- [docs/dream7b_s100p_deployment_optimization/README.md](docs/dream7b_s100p_deployment_optimization/README.md): Dream 7B S100P deployment optimization highlight, organized from the initial no-reference state through official baseline checks, Dream official-route blockage, segmented HBM, selected-pair residency, cross-job service promotion, rollback, and final default-deployable conclusion.
...
- [scripts/probes/dream7b_bpu_selected_pair_service_promotion_gate_probe.sh](scripts/probes/dream7b_bpu_selected_pair_service_promotion_gate_probe.sh): report-only default-service replacement gate for the sustained selected-pair candidate service; it checks live service isolation, sustained telemetry, acceptance, utilization, reload decision, and rollback commands before allowing any promotion.
- [scripts/probes/dream7b_bpu_promotion_blocker_diagnosis_probe.sh](scripts/probes/dream7b_bpu_promotion_blocker_diagnosis_probe.sh): report-only diagnosis that decomposes selected-pair promotion blockers into load/run, average BPU, window-cost, residency-capacity, and next-experiment priorities.
- [scripts/probes/dream7b_final_optimization_acceptance_probe.sh](scripts/probes/dream7b_final_optimization_acceptance_probe.sh): final report-only acceptance gate for Dream 7B BPU optimization, covering deployment closure, measured improvement, 128TOPS wording discipline, promotion/rollback gate, official Dream OELLM status, official fallback status, and next-plan evidence.
- [scripts/probes/dream7b_bpu_normal_use_acceptance_probe.sh](scripts/probes/dream7b_bpu_normal_use_acceptance_probe.sh): normal-use candidate acceptance gate for Dream 7B selected-pair service; it checks clean 48-request sustained service, preferred 96-request evidence, at least two performance-floor metrics, post-blocker reload relief, deployment acceptance, promotion rollback, and `hbm_reload_dominated` wording discipline.
- [scripts/probes/dream7b_bpu_default_deployable_acceptance_probe.sh](scripts/probes/dream7b_bpu_default_deployable_acceptance_probe.sh): final default-deployable gate for Dream 7B selected-pair service; it checks 96/192 sustained service evidence, three-performance-metric promotion criteria, cross-job prototype evidence, reload relief, deployment acceptance, promotion blockers, rollback plan, and compliant `hbm_reload_dominated` wording.
- [scripts/dream7b_bpu_selected_pair_cross_job_queue_runner.py](scripts/dream7b_bpu_selected_pair_cross_job_queue_runner.py): queue-runner candidate that drains multiple pending jobs in one selected-pair resident worker session and writes `cross_job_queue_summary.json`.
- [scripts/dream7b_bpu_selected_pair_cross_job_queue_service.py](scripts/dream7b_bpu_selected_pair_cross_job_queue_service.py): service loop for the selected-pair cross-job queue candidate.
- [scripts/install_dream7b_bpu_selected_pair_cross_job_candidate_service.sh](scripts/install_dream7b_bpu_selected_pair_cross_job_candidate_service.sh): installs the isolated `dream7b-bpu-selected-pair-cross-job-candidate.service` without replacing the default Dream service.
- [scripts/probes/dream7b_bpu_selected_pair_cross_job_queue_telemetry_probe.sh](scripts/probes/dream7b_bpu_selected_pair_cross_job_queue_telemetry_probe.sh): foreground telemetry probe for the cross-job queue runner candidate.
- [scripts/probes/dream7b_bpu_selected_pair_cross_job_service_fallback_probe.sh](scripts/probes/dream7b_bpu_selected_pair_cross_job_service_fallback_probe.sh): single-job fallback flush probe for the cross-job candidate service.
- [scripts/probes/dream7b_bpu_selected_pair_cross_job_service_promotion_gate_probe.sh](scripts/probes/dream7b_bpu_selected_pair_cross_job_service_promotion_gate_probe.sh): promotion gate for the isolated cross-job candidate service.
- [scripts/probes/dream7b_bpu_cross_job_default_promotion_probe.sh](scripts/probes/dream7b_bpu_cross_job_default_promotion_probe.sh): guarded default-service replacement and rollback verification probe for the cross-job route.
- [scripts/probes/dream7b_bpu_cross_job_default_service_telemetry_probe.sh](scripts/probes/dream7b_bpu_cross_job_default_service_telemetry_probe.sh): default queue sustained telemetry probe after promotion.
...
- [scripts/probes/dream7b_bpu_reload_optimization_probe.sh](scripts/probes/dream7b_bpu_reload_optimization_probe.sh): report-only reload optimization decision gate that compares the latest Dream telemetry/window-cost/utilization/acceptance against `best_load_to_run_ratio: 9.468172` and summarizes persistent cache, prefetch/local-cache, selected-pair cache, window scheduling, and BPU scheduling evidence.
...
- [scripts/probes/s100_official_qwen_fullflow_probe.sh](scripts/probes/s100_official_qwen_fullflow_probe.sh): official Qwen source-model fullflow probe for `qwen2_5-1_5b` that records build-host compatibility, `oellm_build`, isolated runtime config, HBM output, `oellm_multichat` stdout/stderr, and optional `hrt_ucp_monitor` telemetry.
- [scripts/probes/s100_official_deepseek7b_baseline_probe.sh](scripts/probes/s100_official_deepseek7b_baseline_probe.sh): official DeepSeek-R1-Distill-Qwen-7B fallback probe that downloads/verifies the vendor HBM, writes an isolated runtime config, captures `oellm_multichat` stdout/stderr plus `hrt_ucp_monitor`, and compares the result with Qwen 1.5B and Dream segmented HBM.
...
- [scripts/probes/dream7b_oellm_fullflow_feasibility_probe.sh](scripts/probes/dream7b_oellm_fullflow_feasibility_probe.sh): Dream 7B official OELLM migration feasibility probe that confirms SDK registry coverage, reruns the DeepSeek/Qwen skeleton compiler path, and emits a minimal failure package when the direct fullflow is blocked.
...
- [docs/dream7b_s100p_50pct_utilization_goal_2026-06-11.md](docs/dream7b_s100p_50pct_utilization_goal_2026-06-11.md): long-run Dream 7B sustained-utilization goal toward `avg_bpu_loading >= 50%`, with the current 2026-06-11 baseline around `9.7%`, Phase 1 gates, and the Phase 1 top-load compile/runtime result.
- [docs/dream7b_s100p_long_running_candidate_2026-06-11.md](docs/dream7b_s100p_long_running_candidate_2026-06-11.md): rollback-safe long-running Dream 7B `2x192` service-candidate plan, 30-minute soak evidence path, and OpenClaw Personal/Movies dry-run recording path.
- [docs/dream7b_s100p_90pct_utilization_route_2026-06-12.md](docs/dream7b_s100p_90pct_utilization_route_2026-06-12.md): 90% utilization route after the 50% service candidate; records the 2/4/8/12 backlog sweep plateau, the 24x192 continuous-prefetch plateau at `avg_bpu_loading: 53.583`, the 12-job segment-major 30-minute soak at `avg_bpu_loading: 86.643`, the 24x192 near-90 service candidate at `avg_bpu_loading: 89.535`, and the 24x256 service candidate that reaches `avg_bpu_loading: 90.275`, a 2-iteration pilot soak at `avg_bpu_loading: 90.327`, and a 2-hour soak at `avg_bpu_loading: 90.264`.
- [docs/dream7b_s100p_90pct_vendor_question_2026-06-12.md](docs/dream7b_s100p_90pct_vendor_question_2026-06-12.md): teacher/vendor-facing minimal question package for Dream adapter, HBM layout, runtime memory pool, and 90% feasibility.
- [docs/dream7b_s100p_90pct_default_candidate_handoff_2026-06-12.md](docs/dream7b_s100p_90pct_default_candidate_handoff_2026-06-12.md): default-candidate handoff for the 24x256 segment-major/load-once Dream 7B route; records the 30-minute 90% soak, the OpenClaw local Dream validation, the 24x192 fallback, rollback commands, and the two-hour soak promotion gate.
- [scripts/probes/dream7b_bpu_phase1_reload_experiment_planner_probe.sh](scripts/probes/dream7b_bpu_phase1_reload_experiment_planner_probe.sh): read-only planner that rejects no-new-HBM selected-pair shortcuts and selects the Phase 1 top-load split compile path.
- [scripts/probes/dream7b_bpu_phase1_segment_plan_preflight_probe.sh](scripts/probes/dream7b_bpu_phase1_segment_plan_preflight_probe.sh): dry-run preflight for the guarded `phase1-topload-adjacent` segment plan; it verifies wiring and reports missing HBM shards without loading BPU runtimes.
- [scripts/probes/dream7b_bpu_cross_job_long_session_telemetry_probe.sh](scripts/probes/dream7b_bpu_cross_job_long_session_telemetry_probe.sh): no-new-HBM long-session telemetry probe that tests selected-pair resident sessions beyond the default 12 jobs; 18x16 reached `avg_bpu_loading: 9.775` and `load_to_run_ratio: 8.711317`, still below Phase 1.
- [scripts/probes/dream7b_bpu_phase1_compile_recovery_package_probe.sh](scripts/probes/dream7b_bpu_phase1_compile_recovery_package_probe.sh): recovery-package generator for the four missing Phase 1 top-load HBM shards. The 2026-06-11 report generated `/mnt/nas/openclaw/reports/models/dream7b_bpu_phase1_compile_recovery_package_20260611-164453/phase1_compile_recovery_runbook.sh`; it confirms Dream HF assets and the S100 LLM SDK are present on NAS, while the current S100P host is not the required x86_64/AVX HBDK builder.
- Phase 1 top-load compile/runtime closure: Docker `linux/amd64` with AVX compiled `2:3 3:4 4:5 5:7` successfully; `/mnt/nas/openclaw/reports/models/dream7b_resplit_compile_20260611-104601/resplit_compile_probe.json` records `hbm_success_count: 4`, `failed_spec_count: 0`, and the NAS manifest verifies all four HBM files. Runtime preflight is ready, but `/mnt/nas/openclaw/reports/models/dream7b_bpu_resplit_batch_telemetry_20260611-190500/resplit_batch_telemetry_probe.json` records `avg_bpu_loading: 6.706` and `load_to_run_ratio: 12.012308`, so the plan is runnable but rejected as a utilization regression.
- [scripts/probes/dream7b_bpu_50pct_candidate_acceptance_probe.sh](scripts/probes/dream7b_bpu_50pct_candidate_acceptance_probe.sh): acceptance wrapper for the large-batch selected-pair candidate. `/mnt/nas/openclaw/reports/models/dream7b_bpu_selected_pair_cross_job_queue_telemetry_20260611-192528/cross_job_queue_telemetry_probe.json` records the current best `2x192` run with `processed_request_count: 384`, `failed_job_count: 0`, `avg_bpu_loading: 52.328`, `load_to_run_ratio: 0.778725`, and `amortized_wall_ms_per_processed_request: 262.083`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_50pct_candidate_acceptance_20260611-193007/50pct_candidate_acceptance_probe.json` records `rollback_status: rollback_safe_candidate_only`, `default_service_replaced: False`, and deployment acceptance `30 / 30`.
- [scripts/probes/dream7b_bpu_50pct_candidate_soak_probe.sh](scripts/probes/dream7b_bpu_50pct_candidate_soak_probe.sh): repeats the Dream 7B selected-pair `2x192` telemetry route for a target soak duration and aggregates average BPU loading, failed jobs, and load/run ratio.
- [scripts/probes/dream7b_bpu_long_running_candidate_acceptance_probe.sh](scripts/probes/dream7b_bpu_long_running_candidate_acceptance_probe.sh): final acceptance wrapper for the Dream 7B long-running candidate; checks soak evidence, service plan, default-service status, and OpenClaw Personal/Movies dry-run evidence.
- [scripts/probes/dream7b_bpu_50pct_candidate_service_telemetry_probe.sh](scripts/probes/dream7b_bpu_50pct_candidate_service_telemetry_probe.sh): systemd-service canary for the isolated 50% Dream 7B candidate service; submits 2-12 backlog jobs and records BPU telemetry.
- [scripts/probes/dream7b_bpu_50pct_service_backlog_sweep_summary_probe.sh](scripts/probes/dream7b_bpu_50pct_service_backlog_sweep_summary_probe.sh): summarizes 2/4/8/12 service backlog telemetry and decides whether backlog depth alone can reach 70-80%.
- [scripts/probes/dream7b_bpu_50pct_candidate_service_continuous_prefetch_probe.sh](scripts/probes/dream7b_bpu_50pct_candidate_service_continuous_prefetch_probe.sh): keeps 12 jobs pending while 12 jobs process on the isolated 50% candidate service. `/mnt/nas/openclaw/reports/models/dream7b_bpu_50pct_candidate_service_continuous_prefetch_20260612-121446/50pct_candidate_service_continuous_prefetch_probe.json` records `processed_request_count: 4608`, `failed_job_count: 0`, `avg_bpu_loading: 53.583`, `aggregate_load_to_run_ratio: 0.732649`, and `decision: continuous_prefetch_plateau_below_70_percent`, so outer queue refill is no longer the primary 70-90% lever.
- [scripts/probes/dream7b_bpu_segment_major_load_once_forward_probe.sh](scripts/probes/dream7b_bpu_segment_major_load_once_forward_probe.sh): offline Stage 3 scheduler that changes execution from job-major repeated segment loads to segment-major load-once execution. `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_load_once_forward_20260612-124719/segment_major_load_once_forward_probe.json` records `processed_forward_count: 2304`, `load_event_count: 10`, `job_major_equivalent_load_event_count: 98`, `load_to_run_ratio: 0.069417`, `avg_bpu_loading: 87.021`, `peak_live_mib: 504.0`, `errors: []`, and `decision: segment_major_load_once_meets_90pct_ratio_gate`.
- [scripts/install_dream7b_bpu_segment_major_load_once_candidate_service.sh](scripts/install_dream7b_bpu_segment_major_load_once_candidate_service.sh): installs the isolated `dream7b-bpu-segment-major-load-once-candidate.service` without replacing the default Dream service or the 50% selected-pair service.
- [scripts/probes/dream7b_bpu_segment_major_candidate_service_telemetry_probe.sh](scripts/probes/dream7b_bpu_segment_major_candidate_service_telemetry_probe.sh): service telemetry probe for the segment-major/load-once candidate. `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_candidate_service_telemetry_20260612-130705/segment_major_candidate_service_telemetry_probe.json` records `processed_request_count: 2304`, `failed_job_count: 0`, `avg_bpu_loading: 86.792`, `max_bpu_loading: 100.0`, `load_to_run_ratio: 0.068115`, `load_event_reduction_ratio: 0.897959`, `peak_live_mib: 504.0`, and `decision: segment_major_service_near_90pct_candidate`.
- [scripts/probes/dream7b_bpu_segment_major_candidate_soak_probe.sh](scripts/probes/dream7b_bpu_segment_major_candidate_soak_probe.sh): multi-iteration soak wrapper for the segment-major/load-once service. `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_candidate_soak_20260612-131931/segment_major_candidate_soak_probe.json` records `iteration_count: 2`, `processed_request_count: 4608`, `failed_job_count: 0`, `avg_bpu_loading: 86.701`, `min_iteration_avg_bpu_loading: 86.667`, `avg_load_to_run_ratio: 0.068132`, and `decision: segment_major_service_soak_near_90pct_candidate`.
- Segment-major 30-minute soak evidence: `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_candidate_soak_20260612-133613/segment_major_candidate_soak_probe.json` records `elapsed_sec: 1892`, `iteration_count: 5`, `processed_request_count: 11520`, `failed_job_count: 0`, `avg_bpu_loading: 86.643`, `min_iteration_avg_bpu_loading: 86.533`, `avg_load_to_run_ratio: 0.068719`, and `decision: segment_major_service_soak_near_90pct_candidate`.
- Segment-major 24-job near-90 evidence: `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_candidate_service_telemetry_20260612-143609/segment_major_candidate_service_telemetry_probe.json` records `job_count: 24`, `processed_request_count: 4608`, `failed_job_count: 0`, `avg_bpu_loading: 89.535`, `load_to_run_ratio: 0.03538`, `peak_live_mib: 1008.0`, and `decision: segment_major_service_near_90pct_candidate`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_candidate_soak_20260612-144904/segment_major_candidate_soak_probe.json` records a two-iteration pilot soak with `processed_request_count: 9216`, `failed_job_count: 0`, `avg_bpu_loading: 89.471`, and `avg_load_to_run_ratio: 0.034434`.
- Segment-major 24x256 90% evidence: `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_candidate_service_telemetry_20260612-161133/segment_major_candidate_service_telemetry_probe.json` records `service_name: dream7b-bpu-segment-major-load-once-candidate-24job-b256.service`, `processed_request_count: 6144`, `failed_job_count: 0`, `avg_bpu_loading: 90.275`, `load_to_run_ratio: 0.02602`, `peak_live_mib: 1344.0`, and `decision: segment_major_service_meets_90pct_goal`; `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_candidate_soak_20260612-162823/segment_major_candidate_soak_probe.json` records a two-iteration pilot soak with `processed_request_count: 12288`, `failed_job_count: 0`, `avg_bpu_loading: 90.327`, `min_iteration_avg_bpu_loading: 90.311`, and `avg_load_to_run_ratio: 0.025995`.
- Segment-major 24x256 2-hour soak evidence: `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_candidate_soak_20260612-171402/segment_major_candidate_soak_probe.json` records `verdict: ok_dream7b_bpu_segment_major_candidate_soak_probe`, `decision: segment_major_service_soak_meets_90pct_goal`, `elapsed_sec: 7723`, `iteration_count: 8`, `processed_request_count: 49152`, `failed_job_count: 0`, `avg_bpu_loading: 90.264`, `min_iteration_avg_bpu_loading: 90.155`, `avg_load_to_run_ratio: 0.026177`, `max_iteration_load_to_run_ratio: 0.027452`, `default_service_replaced: False`, and `rollback_status: rollback_safe_candidate_only`.
- OpenClaw local Dream validation: [scripts/probes/dream7b_openclaw_candidate_validation_probe.py](scripts/probes/dream7b_openclaw_candidate_validation_probe.py) produced `/mnt/nas/openclaw/reports/models/dream7b_openclaw_candidate_validation_20260612-172108/openclaw_candidate_validation_probe.json`, which records `verdict: ok_dream7b_openclaw_candidate_validation_probe`, `primary_model: dream7b-local/Dream7B-S100P-local`, `dream_provider_base_url: http://127.0.0.1:18888/v1`, `minimax_fallback_present: true`, `recent_trace_has_openclaw_heartbeat: true`, `recent_trace_has_sort_trigger: true`, `default_service_replaced: false`, and `errors: []`.
- 24x256 default-candidate handoff: [docs/dream7b_s100p_90pct_default_candidate_handoff_2026-06-12.md](docs/dream7b_s100p_90pct_default_candidate_handoff_2026-06-12.md) keeps `dream7b-bpu-segment-major-load-once-candidate-24job-b256.service` isolated from `dream7b-bpu-batch-queue.service`, retains `dream7b-bpu-segment-major-load-once-candidate-24job.service` as the 24x192 fallback, treats the 2-hour soak as passed, and records rollback as `sudo systemctl disable --now dream7b-bpu-segment-major-load-once-candidate-24job-b256.service`.
- 24x256 evidence package: [scripts/probes/dream7b_90pct_candidate_evidence_package_probe.py](scripts/probes/dream7b_90pct_candidate_evidence_package_probe.py) produces `/mnt/nas/openclaw/reports/models/dream7b_90pct_candidate_evidence_package_final/evidence_package_manifest.json`, which records `verdict: ok_dream7b_90pct_candidate_evidence_package_probe`, `service_24x256_reaches_90: True`, `soak_30min_reaches_90: True`, `soak_2h_reaches_90: True`, `services_active: True`, `openclaw_local_dream_ok: True`, `docs_consistency_ok: True`, and `errors: []`.
- 24x256 default-service promotion: [scripts/probes/dream7b_bpu_segment_major_default_promotion_probe.sh](scripts/probes/dream7b_bpu_segment_major_default_promotion_probe.sh) promoted the segment-major/load-once 24x256 route into `dream7b-bpu-batch-queue.service` on `/mnt/nas/openclaw/queues/dream7b-bpu`. `/mnt/nas/openclaw/reports/models/dream7b_bpu_segment_major_default_promotion_20260612-210011/segment_major_default_promotion_probe.json` records `verdict: ok_dream7b_bpu_segment_major_default_promotion_probe`, `default_service_replaced: True`, `rollback_verified: True`, `smoke_request_id: segment-major-default-smoke-20260612-210011`, `runtime_dir: /mnt/nas/openclaw/runtimes/dream7b-bpu-segment-major-default`, `--max-batch-size 256`, and `errors: []`. [docs/dream7b_s100p_default_service_ops_runbook_2026-06-12.md](docs/dream7b_s100p_default_service_ops_runbook_2026-06-12.md) documents `dream7b-default-status`, `dream7b-default-rollback`, `dream7b-default-health.timer`, and `/etc/logrotate.d/dream7b-default-health`.
- Default promotion fields: `service_name: dream7b-bpu-batch-queue.service`, `queue_dir: /mnt/nas/openclaw/queues/dream7b-bpu`, and `scripts/install_dream7b_default_ops_tools.sh`.
- OpenClaw Dream local copy-sort demo: [scripts/dream7b_local_openai_gateway.py](scripts/dream7b_local_openai_gateway.py) uses the allowlisted `personal_data_sort_probe` by default for the Personal/Movies teacher-demo trigger, preserving originals and writing organized copies under `Personal/Sorted`. `/mnt/nas/openclaw/reports/personal-data-sort/personal_data_sort_20260612-211115/personal_data_sort.md` records `verdict: ok_personal_data_sort_probe`, `file_count: 20`, `copy_count: 20`, `dry_run: False`, `upload_performed: True`, `delete_or_move_performed: False`, and target categories under `Sorted/Movies`.
- Default promotion final acceptance: [scripts/probes/dream7b_default_promotion_acceptance_probe.py](scripts/probes/dream7b_default_promotion_acceptance_probe.py) and [docs/dream7b_s100p_default_promotion_acceptance_2026-06-12.md](docs/dream7b_s100p_default_promotion_acceptance_2026-06-12.md) record the accepted default route. `/mnt/nas/openclaw/reports/models/dream7b_default_promotion_acceptance_20260612-213745/default_promotion_acceptance_probe.json` reports `verdict: ok_dream7b_default_promotion_acceptance_probe`, `decision: dream7b_24x256_segment_major_default_accepted`, `avg_bpu_loading: 90.097`, `failed_job_count: 0`, `elapsed_sec: 1932`, `iteration_count: 2`, `load_to_run_ratio: 0.025975`, `copy_count: 20`, `default_service_replaced: true`, `rollback_verified: true`, `post_promotion_avg_bpu_ge_90: true`, `openclaw_copy_sort_non_destructive: true`, `health_segment_major_default: true`, and `errors: []`.
- [scripts/probes/personal_data_sort_dry_run_probe.sh](scripts/probes/personal_data_sort_dry_run_probe.sh): OpenClaw-safe Personal NAS organization preview for recording; generates Markdown/JSON plans without SMB upload, deletion, move, rename, or overwrite.
