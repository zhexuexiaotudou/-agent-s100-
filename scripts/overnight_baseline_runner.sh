...
log_event "info" "runner_finish" "ok" "iterations=$iteration latest_stability=${latest_stability:-missing} latest_baseline=${latest_baseline:-missing} latest_gap=${latest_gap:-missing} latest_teacher=${latest_teacher:-missing} latest_convergence=${latest_convergence:-missing}"
