...
window_size="${DREAM7B_BPU_FINE_BATCH_WINDOW_SIZE:-2}"
child_window_mode="${DREAM7B_BPU_FINE_BATCH_CHILD_WINDOW_MODE:-pair}"
child_runtime_mode="${DREAM7B_BPU_FINE_BATCH_CHILD_RUNTIME_MODE:-packed}"
window_execution_mode="${DREAM7B_BPU_FINE_BATCH_WINDOW_EXECUTION_MODE:-window-batch}"
tokens_batch_json="${DREAM7B_BPU_TOKENS_BATCH_JSON:-}"
