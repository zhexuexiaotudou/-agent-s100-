...
segments = {
    ...
    "seg07_10": fine_hbm_dir / "seg07_10" / "dream7b_segment_7_10_seq16_q8.hbm",
    "seg10_14": fine_hbm_dir / "seg10_14" / "dream7b_segment_10_14_seq16_q8.hbm",
    "seg14_21": base_hbm_dir / "dream7b_segment_14_21_seq16_q8.hbm",
    "seg14_17": fine_hbm_dir / "seg14_17" / "dream7b_segment_14_17_seq16_q8.hbm",
    "seg17_21": fine_hbm_dir / "seg17_21" / "dream7b_segment_17_21_seq16_q8.hbm",
...
critical_pairs = {
    ...
    tuple(["seg04_07", "seg07_10"]),
    tuple(["seg07_10", "seg10_14"]),
    tuple(["seg10_14", "seg14_17"]),
    tuple(["seg14_17", "seg17_21"]),
    tuple(["seg17_21", "seg21_24"]),
