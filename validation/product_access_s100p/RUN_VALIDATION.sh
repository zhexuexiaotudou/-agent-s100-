...
run service_access systemctl status --no-pager digua-product-access.service
run service_portal systemctl status --no-pager openclaw-gateway.service
run service_qwen systemctl status --no-pager qwen25-local-openai-gateway.service
run sockets ss -lntp
