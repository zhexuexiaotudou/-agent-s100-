...
- Current Dream 7B deployment acceptance: `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260606-212134/deployment_acceptance_probe.json` reports `check_count: 16`, `passed_check_count: 16`, `min_batch_generate_count: 16`, `min_batch_generate_sustained_round_count: 3`, and `utilization_gap.ok: True`.
