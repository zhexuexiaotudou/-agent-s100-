...
- [scripts/probes/dream7b_bpu_text_queue_systemd_probe.sh](scripts/probes/dream7b_bpu_text_queue_systemd_probe.sh): calls `dream7b-bpu-text-queue-submit`, waits for `dream7b-bpu-batch-queue.service`, and verifies BPU `topk_last_position` output.
