...
- Current Dream 7B deployment acceptance: `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260606-205153/deployment_acceptance_probe.json` reports `check_count: 15`, `passed_check_count: 15`, `min_batch_generate_count: 16`, `min_batch_generate_sustained_round_count: 3`, and `diffusion_batch_generate_sustained.ok: True`.
