...
- Current Dream 7B deployment acceptance: `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260606-125750/deployment_acceptance_probe.json` reports `check_count: 22`, `passed_check_count: 22`, `min_batch_generate_count: 16`, `min_batch_generate_sustained_round_count: 3`, `utilization_gap.ok: True`, `persistent_pair_cache.ok: True`, `held_pair_residency_matrix.ok: True`, `single_segment_residency_matrix.ok: True`, `persistent_segment_cache.ok: True`, `single_segment_triplet_residency.ok: True`, and `seeded_quad_residency.ok: True`.
