...
- Current Dream 7B deployment acceptance: `/mnt/nas/openclaw/reports/models/dream7b_bpu_deployment_acceptance_20260605-234654/deployment_acceptance_probe.json` reports `check_count: 17`, `passed_check_count: 17`, `min_batch_generate_count: 16`, `min_batch_generate_sustained_round_count: 3`, `utilization_gap.ok: True`, and `persistent_pair_cache.ok: True`.
