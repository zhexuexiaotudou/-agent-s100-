...
- [scripts/probes/dream7b_bpu_deployment_acceptance_probe.sh](scripts/probes/dream7b_bpu_deployment_acceptance_probe.sh): report-only deployment acceptance gate that aggregates the latest Dream 7B BPU service, HBM artifact inventory, batch capacity, systemd batch/drain/canary/text-queue/diffusion-generate/telemetry, long-repeat, and queue-retention reports.
