...
Status: historical Dream7B/AI-NAS package checklist.

As of 2026-06-23, Dream7B is no longer the continuing model direction for this
project. Use this checklist only for extracting reusable release hygiene ideas:
mock probes, source/binary separation, evidence paths, and private-data review.
Do not use it as an instruction to publish the current Dream7B package.
