...
- use `dream7b-bpu-fine-forward-window-batch-probe` evidence for concurrent independent-request batching, but do not treat it as a single-request Dream diffusion speedup;
