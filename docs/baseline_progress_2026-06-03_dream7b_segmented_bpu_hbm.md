...
- before retrying four-resident forward paths, recompile or split weak residency segments `[0, 9, 4, 6]` into smaller HBM shards; the segment capacity planner records `successful_seeded_quad_count: 0` for the current 10-segment split;
