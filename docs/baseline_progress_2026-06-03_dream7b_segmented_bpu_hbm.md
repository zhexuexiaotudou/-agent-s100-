...
- compare the passing direct HBMEM/UCP allocation matrix with official Qwen's `backend: 9` failure path before using official Qwen as a clean utilization baseline;
