...
- run telemetry against `dream7b-bpu-resplit-batch-forward` before any default-service promotion; batch 16 reaches logits, but `load_to_run_ratio: 10.014756` still shows the route is load/residency dominated;
