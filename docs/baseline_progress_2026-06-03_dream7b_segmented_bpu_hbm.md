...
- replace `dream7b-bpu-batch-queue-runner` with a long-lived service after directory watch and daemon supervision are specified and verified; do not treat this as a single-request Dream diffusion speedup;
