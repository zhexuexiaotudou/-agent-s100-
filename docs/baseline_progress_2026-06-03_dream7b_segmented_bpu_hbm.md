...
- run a controlled official Qwen `bpu_core` sweep with copied configs for exact values `-1`, `0`, `1`, `2`, and `3` before using official Qwen as a clean utilization baseline or transferring any backend/core-pinning idea to Dream 7B;
