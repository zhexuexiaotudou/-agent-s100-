...
- inspect S100P BPU/common-buffer memory pool and official runtime performance-mode prerequisites before using official Qwen as a clean utilization baseline;
