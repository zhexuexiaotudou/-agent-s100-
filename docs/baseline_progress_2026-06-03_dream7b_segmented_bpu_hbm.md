...
- wire `dream7b-bpu-selected-pair-batch-forward` into a guarded default-service candidate, then rerun deployment acceptance before replacing the current default Dream 7B service path;
