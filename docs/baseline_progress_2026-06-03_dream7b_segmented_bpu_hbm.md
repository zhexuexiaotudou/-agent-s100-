...
- add daemon supervision for `dream7b-bpu-batch-queue-service` after the desired queue root and restart policy are selected; do not treat this as a single-request Dream diffusion speedup;
