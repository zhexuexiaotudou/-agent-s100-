...
- benchmark the verified `dream7b-bpu-resplit-forward` path with batch, telemetry, and sustained-service probes before any default-service promotion; the first reusable resplit forward gate reaches logits but still records `load_ms: 23906.713` versus `run_ms: 152.863`;
