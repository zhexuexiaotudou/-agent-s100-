...
- Smart classification creates virtual collections only.
- Materialized organization only produces a copy plan and requires Harness execution.
...
inference; cloud vision or cloud ASR; automatic delete/move/rename; complete
replacement of a commercial NAS OS.
```
